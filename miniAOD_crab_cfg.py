...
# with command line options: step1 --filein dbs:/DY1JetsToLL_M-50_LHEZpT_400-inf_TuneCP5_13TeV-amcnloFXFX-pythia8/RunIIAutumn18DRPremix-102X_upgrade2018_realistic_v15-v1/AODSIM --fileout file:EXO-RunIIAutumn18MiniAOD-00268.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v15 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename EXO-RunIIAutumn18MiniAOD-00268_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 8597
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("file:fileAOD.root"),
...
#    fileName = cms.untracked.string('file:EXO-RunIIAutumn18MiniAOD-00268.root'),
