...
# with command line options: step2 --filein file:EXO-RunIIAutumn18DRPremix-00258_step1.root --fileout file:EXO-RunIIAutumn18DRPremix-00258.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --nThreads 8 --era Run2_2018 --python_filename EXO-RunIIAutumn18DRPremix-00258_2_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 2626
...
#    fileNames = cms.untracked.vstring('file:EXO-RunIIAutumn18DRPremix-00258_step1.root'),
    fileNames = cms.untracked.vstring("file:DR_step1.root"),
...
#    fileName = cms.untracked.string('file:EXO-RunIIAutumn18DRPremix-00258.root'),
    fileName = cms.untracked.string("file:fileAOD.root"), 
